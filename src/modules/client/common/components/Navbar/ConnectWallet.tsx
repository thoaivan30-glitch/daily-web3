...
const ConnectWallet: React.FC = () => {
  // Tạm thời tắt chức năng kết nối ví
  ...
  const handleClick = () => {
    console.log('Chức năng kết nối ví đã tạm thời tắt');
  };
  ...
  return (
    <div className="relative">
      <button 
        ...
        className="px-4 py-2.5 text-sm bg-[#00A3FF] text-white rounded-lg hover:bg-[#0086D6] transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/50 flex items-center gap-3"
      >
        {/* {isConnecting ? (
          <>
          ...
          <>
            <IconifyIcon icon="ph:wallet-fill" className='w-4 h-5' />
            {isConnected && address ? (
              <>
